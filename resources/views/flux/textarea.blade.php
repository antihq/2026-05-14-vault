...
$classes = Flux::classes()
    ...
    ->add('text-base sm:text-sm text-zinc-950 disabled:text-zinc-500 placeholder-zinc-400 disabled:placeholder-zinc-400/70 dark:text-white dark:disabled:text-zinc-400 dark:placeholder-zinc-400 dark:disabled:placeholder-zinc-500')
    ->add('border-zinc-300/80 border-b-zinc-400/60 dark:border-white/10 dark:disabled:border-white/5')
