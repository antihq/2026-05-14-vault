...
$classes = Flux::classes()
    ...
    ->add('text-base/6 sm:text-sm/6 font-medium text-zinc-600 hover:text-zinc-800 dark:hover:text-white dark:text-white/70 data-checked:text-zinc-800 dark:data-checked:text-white')
